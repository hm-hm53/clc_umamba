...
from CLC_UMamba import CLC_UMamba
...
weights_name = "eunetmamba1-r18-768crop-ms-e100"
weights_path = "model_weights/potsdam/{}".format(weights_name)
test_weights_name = "eunetmamba1-r18-768crop-ms-e100"
...
#  define the network
net = EUnetmamba(num_classes=num_classes)
